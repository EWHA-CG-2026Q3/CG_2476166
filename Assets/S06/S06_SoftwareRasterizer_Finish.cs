...
public class S06_SoftwareRasterizer_Finish : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 vertexA = new Vector2(128, 220);
    [SerializeField] private Vector2 vertexB = new Vector2(30, 30);
    [SerializeField] private Vector2 vertexC = new Vector2(226, 110);
    [SerializeField] private Color fillColor = new Color(1f, 0.4f, 0.7f, 1f);
